...
export const updateTransporteRequest = (id, transporte) => axios.put(`/transporte/${id}`, transporte);
export const getTransporteByIdRequest = (id) => axios.get(`/transporte/${id}`);
export const deleteTransporteRequest = (id) => axios.delete(`/transporte/${id}`);
